    ...
    <div style="margin: 200px auto; background-color: #fff; width: 350px; height: 400px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item prop="comfirmpassword">
          <el-input placeholder="确认密码" size="medium" style="margin: 5px 0" prefix-icon="el-icon-lock" show-password v-model="user.comfirmpassword"></el-input>
        </el-form-item>
...
<style scoped>
  .wrapper {
    height: 100vh;
    background-image: linear-gradient(to bottom right, #8b43ce , #17265c);
    overflow: hidden;
  }
</style>